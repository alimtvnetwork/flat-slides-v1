...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  shortcut("toggle-focus-editor", "Focus editor", [], "Edit focus regions", "Presenter"),
  ...
  shortcut("present-window", "Shift+W", ["shift+w"], "Open presenter in new window (popup)", "Presenter"),
